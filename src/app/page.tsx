...
export default function LandingPage() {
  ...
  <div id="nav" data-section="nav">
      ...
      button={{
        text: "Resume",
        href: "http://img.b2bpic.net/free-photo/upload-icon-front-side_187299-45737.jpg",
      }}
    />
  </div>
      ...
      bulletPoints={[
        {
          ...
          description: "MSc in Big Data Analytics at St. Joseph’s College (Autonomous), Bengaluru.",
        },
        {
          title: "Oracle AI Foundations Certified",
          description: "Validated expertise in Oracle Cloud Infrastructure AI, cloud systems, and data analytics.",
        },
        {
          title: "Leadership & Strategy Programs",
          description: "Participant in the Aspire Leaders Program and McKinsey Forward Program.",
        },
        {
          title: "Diverse Technical Experience",
          description: "Proficient in AI systems, Oracle APEX, cloud infrastructure, cybersecurity, cryptography, databases, and MERN stack technologies.",
        },
      ]}
  ...
  <div id="projects" data-section="projects">
      ...
      products={[
        {
          id: "pos-webapp",
          name: "Multi-Seller POS Web App",
          price: "Case Study",
          imageSrc: "http://img.b2bpic.net/free-photo/businesswoman-eating-tasty-sandwich-having-meal-break-working-business-company-office-takeout-lunchbreak_482257-2136.jpg",
          imageAlt: "Mockup of a POS web application dashboard",
        },
        {
          id: "oracle-apex-workflow",
          ...
          imageAlt: "Mockup of an Oracle APEX workflow automation system",
        },
        {
          id: "student-food-platform",
          ...
          imageAlt: "Mockup of a student food ecosystem platform",
        },
        {
          id: "skillforge",
          name: "SkillForge - AI Career Platform",
          price: "Case Study",
          ...
          imageAlt: "Mockup of SkillForge AI-driven career intelligence platform",
        },
        {
          id: "cybersecurity-platform",
          name: "Cybersecurity Incident Response",
          price: "Case Study",
          imageSrc: "http://img.b2bpic.net/free-photo/empty-military-operation-headquarters-follow-threats-radar-surveillance_482257-91207.jpg",
          imageAlt: "Mockup of a cybersecurity incident response platform",
        },
        {
          ...
          imageAlt: "Mockup of a predictive analytics dashboard",
        },
      ]}
      ...
      team={[
        {
          ...
          role: "St. Joseph’s College (Autonomous), Bengaluru",
          imageSrc: "http://img.b2bpic.net/free-photo/business-data-analysis-presentation-information-concept_53876-144422.jpg",
          imageAlt: "Abstract representation of big data analytics",
        },
        {
          id: "oracle-ai-foundations",
          name: "Oracle Cloud Infrastructure AI Foundations Certified",
          role: "Certification",
          imageSrc: "http://img.b2bpic.net/free-vector/gradient-data-logo-template_23-2149200603.jpg",
          imageAlt: "Oracle AI Foundations certification badge",
        },
        {
          id: "aspire-leaders",
          ...
          imageAlt: "Abstract image representing a leadership program",
        },
        {
          id: "mckinsey-forward",
          name: "McKinsey Forward Program",
          role: "Participant",
          imageSrc: "http://img.b2bpic.net/free-photo/business-executives-discussing-with-their-colleagues-whiteboa_1170-1835.jpg",
          imageAlt: "Abstract image representing a professional development program",
        },
        {
          ...
          imageAlt: "Abstract image representing cybersecurity",
        },
        {
          id: "workflow-systems",
          ...
          imageAlt: "Abstract image representing workflow systems",
        },
        {
          id: "legal-practice",
          name: "Legal Practice Environments",
          role: "Internship Experience",
          imageSrc: "http://img.b2bpic.net/free-photo/blurred-night-lights_23-2148139358.jpg",
          imageAlt: "Abstract image representing legal practice",
        },
      ]}
  ...
  <div id="certifications" data-section="certifications">
      ...
      metrics={[
        ...
        {
          id: "cybersecurity-exp",
          icon: Shield,
          title: "Cybersecurity Experience",
          value: "Applied",
        },
        {
          id: "forensic-internship",
          icon: BarChart,
          title: "Forensic Science Internship",
          value: "Completed",
        },
        {
          id: "legal-internship",
          icon: Scale,
          title: "Legal Practice Internship",
          value: "Completed",
        },
      ]}
      ...
      faqs={[
        {
          id: "command-about",
          title: "about",
          content: "Willson is an AI Systems Builder, Data Strategist, and Cybersecurity-Focused Engineer. He builds intelligent digital systems at the intersection of AI, analytics, cloud infrastructure, and human-centered design.",
        },
        {
          id: "command-projects",
          title: "projects",
          content: "Explore featured works including a Multi-Seller POS Web App, Oracle APEX Workflow System, Student Food Platform, and SkillForge (AI Career Platform). Each project showcases architectural precision and product vision.",
        },
        {
          id: "command-skills",
          title: "skills",
          content: "Proficient in Python, SQL, Oracle APEX, OCI, AI Systems, Cybersecurity, PostgreSQL, MongoDB, and Data Analytics. Mastering interconnected technologies for intelligent system engineering.",
        },
        {
          id: "command-certifications",
          title: "certifications",
          content: "Certifications include Oracle AI Foundations, participation in Aspire Leaders Program and McKinsey Forward Program, and experience in cybersecurity, forensic science, and legal practice.",
        },
        {
          id: "command-contact",
          title: "contact",
          content: "To connect, visit the contact section. You can reach out via LinkedIn, GitHub, or email, or download my resume.",
        },
        {
          id: "command-resume",
          title: "resume",
          content: "You can download Willson's full professional resume from the navigation bar or the contact section for a comprehensive overview of his experience.",
        },
        {
          id: "command-help",
          title: "help",
          content: "Available commands: 'about', 'projects', 'skills', 'certifications', 'contact', 'resume', 'help', 'clear'. Click any command to view its details.",
        },
        {
          id: "command-clear",
          title: "clear",
          content: "Terminal screen cleared. Ready for your next command.",
        },
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      leftLink={{
        text: "LinkedIn",
        href: "https://www.linkedin.com/in/willson-ai",
      }}
      rightLink={{
        text: "GitHub",
        href: "https://github.com/willson-dev",
      }}
    />
  </div>
      </ReactLenis>
